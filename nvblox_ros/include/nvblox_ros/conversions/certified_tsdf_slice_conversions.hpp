...
#ifndef NVBLOX_ROS__CONVERSIONS__CERTIFIED_TSDF_SLICE_CONVERSIONS_HPP_
#define NVBLOX_ROS__CONVERSIONS__CERTIFIED_TSDF_SLICE_CONVERSIONS_HPP_
...
class CertifiedTsdfSliceConverter {
 public:
  CertifiedTsdfSliceConverter();

  // Create a distance map slice from an ESDF layer. Only works with z-axis
  // slices for now.
  void distanceMapSliceFromLayer(const CertifiedTsdfLayer& layer,
                                 float z_slice_level,
                                 nvblox_msgs::msg::DistanceMapSlice* map_slice);

  void distanceMapSliceFromLayers(const CertifiedTsdfLayer& layer_1,
                                  const CertifiedTsdfLayer& layer_2,
                                  float z_slice_level,
...
#endif  // NVBLOX_ROS__CONVERSIONS__CERTIFIED_ESDF_SLICE_CONVERSIONS_HPP_
