...
#ifndef NVBLOX_ROS__CONVERSIONS__CERTIFIED_ESDF_SLICE_CONVERSIONS_HPP_
#define NVBLOX_ROS__CONVERSIONS__CERTIFIED_ESDF_SLICE_CONVERSIONS_HPP_
...
class CertifiedEsdfSliceConverter
{
public:
  CertifiedEsdfSliceConverter();
